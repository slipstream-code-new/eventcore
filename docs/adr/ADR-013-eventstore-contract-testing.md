...
the contract helpers. (See ADR-015 for the updated crate location — the module now
lives in the `eventcore-testing` crate as `eventcore_testing::contract`.) It should export:
