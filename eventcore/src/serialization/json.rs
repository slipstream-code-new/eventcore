//! JSON serialization implementation for events.
...
/// JSON-based event serializer with schema versioning support.
#[derive(Clone)]
...
impl JsonEventSerializer {
    ...
    /// Creates a new JSON event serializer with schema evolution support.
