//! Bincode serialization implementation for events.
...
/// Bincode-based event serializer with schema versioning support.
#[derive(Clone)]
...
impl BincodeEventSerializer {
    /// Creates a new Bincode event serializer.
    pub fn new() -> Self {
        Self {
    ...
    /// Creates a new Bincode event serializer with schema evolution support.
